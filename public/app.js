class HealthTrackApp {
    ...
    setupEventListeners() {
        ...
        // Forms
        document.getElementById('health-form').addEventListener('submit', (e) => this.addHealthRecord(e));
        document.getElementById('medication-form').addEventListener('submit', (e) => this.addMedication(e));
    }
        ...
        container.innerHTML = records.map(record => `
            <div class="record-item">
                <div class="record-header">
                    ...
                    <span class="record-date">${new Date(record.recordedAt).toLocaleDateString()}</span>
                </div>
        ...
        container.innerHTML = medications.map(med => `
            <div class="medication-item">
                <div class="medication-header">
                    ...
                    <span class="medication-schedule">${med.reminderTimes.join(', ')}</span>
                </div>
                <div class="medication-dosage">${med.dosage.amount} ${med.dosage.unit} - ${med.frequency.times}x ${med.frequency.period}</div>
    ...
    displayStats(stats) {
        ...
        const typeCards = Object.entries(stats.types).map(([type, data]) => `
            <div class="stat-card">
